...
namespace numerical
{
TEST(numericalCalculateAngle, calculateAngle_shouldReturnProperAngle)
{
...
TEST(numericalCalculateAngle, calculateAngle_shouldReturnProperAngle_forAxisPoints)
{
...
TEST(numericalCalculateAngle, calculateAngle_shouldReturnProperAngle_forCenterPoint)
{
